...
function plotSim(Model::T1; ana::Union{Matrix, Bool}=false, N::Int64=1000, α::T=0.5, θ::T=5.0, ctrller::String="MDP" ) where {T<:Float64, T1<:Tuple}
    ...
    return plt_Q, bar_Q, plt_T, bar_T, plt_h, bar_h, plt_arb
end
